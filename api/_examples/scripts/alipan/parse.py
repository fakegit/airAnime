"""Parse raw.docx (alipan anime list) into alipan.json + alipan_full.json.

Output (next to this script):
  alipan.json       — [{title, link: share ID}]
  alipan_full.json  — [{title, link: full URL}]
...
OUT_RAW = os.path.join(HERE, "alipan_full.json")
OUT_PURE = os.path.join(HERE, "alipan.json")
